...
for (let i = 0; i < 9; i++) {
    count = 9 * i;
    document.getElementsByClassName("box")[i].innerHTML = "<div class='cell'><input type='text' maxlength='1' id='" + (count + 1) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 2) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 3) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 4) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 5) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 6) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 7) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 8) +
        "'class='input'></div><div class='cell'><input type='text' maxlength='1' id='" + (count + 9) + "'class='input'></div>"
}
